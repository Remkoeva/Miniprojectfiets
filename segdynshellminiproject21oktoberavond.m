...
elseif index == 4
    ...
    a_semimem  = 0;
    a_semiten  = 0;
    a_gmaxsup  = abs(Moment / (Fmaxfv_gmaxsup * d_Glut_max_heup));
    a_gmaxmid  = 0;
    a_gmaxinf  = 0;
    a_ilia     = 0;
    a_psoas    = 0;
...
elseif index == 5
    ...
    a_semiten  = 0;
    a_gmaxsup  = 0;
    a_gmaxmid  = abs(Moment / (Fmaxfv_gmaxmid * d_Glut_max_heup));
    a_gmaxinf  = 0;
    a_ilia     = 0;
    a_psoas    = 0;
    a_recfem   = 0;
...
elseif index == 6
    ...
    a_gmaxsup  = 0;
    a_gmaxmid  = 0;
    a_gmaxinf  = abs(Moment / (Fmaxfv_gmaxinf * d_Glut_max_heup));
    a_ilia     = 0;
    a_psoas    = 0;
    a_recfem   = 0;
    end
...
a_all = [a_bicfemlh, a_semimem, a_semiten, ...
         a_gmaxsup, a_gmaxmid, a_gmaxinf, ...
         a_ilia, a_psoas, a_recfem];
...
if parms.calculate_outputs
    y = [Vnew,vspier,fip_heup,fip_knie,Mcontrol,M_heup_tot,M_spier_heup,potmomflex,potmomext,a_all];%,v_gmaxsup,a_all];
end
